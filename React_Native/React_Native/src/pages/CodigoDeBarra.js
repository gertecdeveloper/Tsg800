...
import { SafeAreaView, Text, StatusBar, View, Button, Alert ,StyleSheet,DeviceEventEmitter,FlatList} from "react-native";
...
export default class CodigoDeBarra extends Component  {
  ...
  startCamera(title){
    ...
    ToastExample.startCameraV1(title);
  ...
  Barcodes() {
    return ["EAN 8", "EAN 13", "EAN 14", "QRCODE"].map(e =>
      <Button title={e} onClick={(e) =>  this.startCamera(e)} />
    )
  }
