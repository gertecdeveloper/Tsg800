...
export default class Impressao extends Component {  
    ...
    statusImpressora(){
        ...
        setTimeout(() => { 
            Alert.alert(this.state.statusPrint); 
        }, 100);
    }
        ...
        return (
            <View>
                ...
                <View style={styles.fixToText}>
                    ...
                    ><View style={{ height: 0.5, width: "100%", backgroundColor: "black" }} /></Button>
                    <Button
                        color= 'gray'
                        title="IMPRIMIR IMAGEM"
                        onPress={() => ToastExample.imprimeImagem()}
                    />
                </View>
                <View style={{marginStart:3,   flexDirection: 'row',
           justifyContent: 'space-between',marginEnd:20}} >
           ...
           justifyContent: 'space-between',marginEnd:10}} >
                    <Picker
